...
listenerTypes = "xmi|aucompare|csv|simpleCsv"
...
query= "SELECT top 100 a.[TIUDocumentSID] ,[ReportText]   " +
		"FROM [ORD_Iwashyna_201108021D].[Src].[TIUDocument_8925] as b   , "+
		"[ORD_Iwashyna_201108021D].[nlp].[NLP_VitalsCorpus_v2] as a  where a.tiudocumentsid = b.TIUDocumentSID"
batchSize=10000
startId= 1
endId=   100
