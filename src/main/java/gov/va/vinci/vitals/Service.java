...
import gov.va.vinci.vitals.pipeline.BasePipeline;
 ...
 * @author OVP
 *
 * Project specific service class that defines the pipeline deployment **/
...
public class Service {
	...
	public static void main(String[] args) {
		Service current_service = new Service();
		if (args.length == 0) {
			current_service.serviceConfigFile = new File[]{new File("config/ServiceConfig.groovy")};
			current_service.pipeline = new String[]{"gov.va.vinci.vitals.pipeline.VitalsPipeline"};
		} else {
