...
public class Service {
	...
	public static class PipelineVariables {
		...
		static {
			apaResourceToType.put("gov.va.vinci.vitals.types.NumericExclude",
					"numericValuesExclude.pattern");
			apaResourceToType.put("gov.va.vinci.vitals.types.TermExclude",
					"termsExclude.pattern");
			apaResourceToType.put("gov.va.vinci.vitals.types.Relation",
					"relation.pattern");
		}
	...
	protected LeoAEDescriptor createPipeline(LeoTypeSystemDescription types)
		...
		for (Entry<String, String> a : PipelineVariables.apaResourceToType
			...
			aggregate
					.addDelegate(new AnnotationPatternAnnotator()
							...
							.setParameterSetting(
									AnnotationPatternAnnotator.Param.RESOURCE
											.getName(),
									PipelineVariables.RESOURCE_PATH
											+ a.getValue())
							.setParameterSetting(
									AnnotationPatternAnnotator.Param.OUTPUT_TYPE
											.getName(), a.getKey())
							.addTypeSystemDescription(types));
		}
		...
		aggregate.addDelegate(new AnnotationFilter()
				...
				.setParameterSetting(
						AnnotationFilter.Param.REMOVE_OVERLAPPING.getName(),
						true).addTypeSystemDescription(types));
		aggregate.addDelegate(new AnnotationFilter()
				.getLeoAEDescriptor()
				.setParameterSetting(
						AnnotationFilter.Param.TYPES_TO_KEEP.getName(),
	...
	protected LeoTypeSystemDescription createTypeSystem() throws Exception {
		...
		// FIXME: types.addTypeSystemDescription(new
		// RegexAnnotator().getLeoTypeSystemDescription());
		TypeDescription newType;

		// Regex default type
		newType = new TypeDescription_impl(PipelineVariables.RegexType, "",
		...
		// APA default type
		newType = new TypeDescription_impl(PipelineVariables.PatternType, "",
				"uima.tcas.Annotation");
		newType.addFeature("pattern", "", "uima.cas.String");
		...
		newType = new TypeDescription_impl(PipelineVariables.LogicType, "",
				"uima.tcas.Annotation");
		...
		newType = new TypeDescription_impl(PipelineVariables.TYPE_BP, "",
				"uima.tcas.Annotation");
		newType.addFeature("SystolicValue", "", "uima.cas.String");
		newType.addFeature("DiastolicValue", "", "uima.cas.String");
		newType.addFeature("Unit", "", "uima.tcas.Annotation");
		types.addType(newType);

		newType = new TypeDescription_impl(PipelineVariables.TYPE_HR, "",
				"uima.tcas.Annotation");
		newType.addFeature("Value", "", "uima.cas.String");
		newType.addFeature("Unit", "", "uima.tcas.Annotation");
		types.addType(newType);
		newType = new TypeDescription_impl(PipelineVariables.TYPE_TEMP, "",
				"uima.tcas.Annotation");
		newType.addFeature("Value", "", "uima.cas.String");
		newType.addFeature("Unit", "", "uima.tcas.Annotation");
		types.addType(newType);
