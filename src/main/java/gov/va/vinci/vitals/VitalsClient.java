...
public class VitalsClient  {
	...
	public static void main(String[] args) throws CmdLineException {
		if (args.length < 3) {
			new VitalsClient(new File("config/ClientConfig.groovy"),
					new File("config/readers/FileCollectionReaderConfig.groovy"),
					new File[]{
			...
			VitalsClient bean = new VitalsClient();
	...
	public static void printUsage() {
		CmdLineParser parser = new CmdLineParser(new VitalsClient());
		System.out.print("Usage: java " + VitalsClient.class.getCanonicalName());
