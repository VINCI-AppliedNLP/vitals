package gov.va.vinci.vitals.readers;
 ...
 * Time: 11:44
 */
public class GCBatchDatabaseCollectionReader extends DatabaseCollectionReader {
    /**
     * Min record ID.
     */
     ...
     */
    public GCBatchDatabaseCollectionReader() { /** Do Nothing **/ }
     ...
     */
    public GCBatchDatabaseCollectionReader(DatabaseConnectionInformation databaseConnectionInformation,
     ...
     * @param batchSize size of each batch to retrieve at a time.  Optimal size will vary with the database environment.
     */
    public GCBatchDatabaseCollectionReader(String driver, String url, String username, String password, String query,
     ...
     */
    public GCBatchDatabaseCollectionReader setMinRecordNumber(int minRecordNumber) {
        this.minRecordNumber = minRecordNumber;
        return this;
    }
     ...
     * @return reference to this reader instance
     */
    public GCBatchDatabaseCollectionReader setMaxRecordNumber(int maxRecordNumber) {
        this.maxRecordNumber = maxRecordNumber;
        return this;
    }
     ...
     * @return reference to this reader instance
     */
    public GCBatchDatabaseCollectionReader setBatchSize(int batchSize) {
        this.batchSize = batchSize;
        return this;
    }
     ...
     * @return reference to this reader instance
     */
    public GCBatchDatabaseCollectionReader setRandomBatches(int randomBatches) {
