...
public class OutputValue extends Annotation {
  ...
  */  
  ...
  public String getValueType() {
    if (OutputValue_Type.featOkTst && ((OutputValue_Type)jcasType).casFeat_valueType == null)
      jcasType.jcas.throwFeatMissing("valueType", "gov.va.vinci.vitals.types.OutputValue");
    return jcasType.ll_cas.ll_getStringValue(addr, ((OutputValue_Type)jcasType).casFeatCode_valueType);}
  ...
  public void setValueType(String v) {
    if (OutputValue_Type.featOkTst && ((OutputValue_Type)jcasType).casFeat_valueType == null)
      jcasType.jcas.throwFeatMissing("valueType", "gov.va.vinci.vitals.types.OutputValue");
    jcasType.ll_cas.ll_setStringValue(addr, ((OutputValue_Type)jcasType).casFeatCode_valueType, v);}    
