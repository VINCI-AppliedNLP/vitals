...
public class OutputValue_Type extends Annotation_Type {
  ...
  private final FSGenerator fsGenerator = 
    new FSGenerator() {
      public FeatureStructure createFS(int addr, CASImpl cas) {
  			 if (OutputValue_Type.this.useExistingInstance) {
  			   // Return eq fs instance if already created
  		     FeatureStructure fs = OutputValue_Type.this.jcas.getJfsFromCaddr(addr);
  		     if (null == fs) {
  		       fs = new OutputValue(addr, OutputValue_Type.this);
  			   OutputValue_Type.this.jcas.putJfsFromCaddr(addr, fs);
  			   return fs;
  		     }
  		     return fs;
        } else return new OutputValue(addr, OutputValue_Type.this);
  	  }
    };
  /** @generated */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = OutputValue.typeIndexID;
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("gov.va.vinci.vitals.types.OutputValue");
  ...
  public String getValue1(int addr) {
      ...
      jcas.throwFeatMissing("value1", "gov.va.vinci.vitals.types.OutputValue");
  ...
  public String getValue2(int addr) {
      ...
      jcas.throwFeatMissing("value2", "gov.va.vinci.vitals.types.OutputValue");
  ...
  public String getValueType(int addr) {
      ...
      jcas.throwFeatMissing("valueType", "gov.va.vinci.vitals.types.OutputValue");
  ...
  public int getUnit(int addr) {
      ...
      jcas.throwFeatMissing("unit", "gov.va.vinci.vitals.types.OutputValue");
  ...
  public String getSource(int addr) {
      ...
      jcas.throwFeatMissing("source", "gov.va.vinci.vitals.types.OutputValue");
  ...
  /** initialize variables to correspond with Cas Type and Features
	 ...
	 * @param casType Type 
	 */
  public OutputValue_Type(JCas jcas, Type casType) {
    super(jcas, casType);
