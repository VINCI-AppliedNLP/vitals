...
public class ValidationRelation extends Relation {
  ...
  public final static int typeIndexID = JCasRegistry.register(ValidationRelation.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected ValidationRelation() {/* intentionally empty block */}
    
  /** Internal - constructor used by generator 
   * @generated */
  public ValidationRelation(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  
  /** @generated */
  public ValidationRelation(JCas jcas) {
    super(jcas);
    readObject();   
  } 

  /** @generated */  
  public ValidationRelation(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
